...
var dv1 = dom.create('<div>zaima?</div>');
var a1 = window.a1;
window.dom.append(a1, dv1);
console.log(a1);
console.log(dv1);
var dv1Parent = dom.create("<div id='dv1Parent'></div>");
dom.wrap(dv1, dv1Parent); //removeEventListener无法删除绑定的匿名函数
...
console.log(divList);
dom.each(divList, function (nodes) {
  dom.class.remove(nodes, 'red');
  dom.class.add(nodes, 'pink');
});
var x = dom.create('<div>before<div>');
dom.before(a1, x);
